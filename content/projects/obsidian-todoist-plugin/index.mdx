...
import queryExample from "./query-example.png";
...
This project is an [Obsidian](https://obsidian.md/) plugin which allows you to materialize [Todoist](https://todoist.com/home) task queries into your notes.
