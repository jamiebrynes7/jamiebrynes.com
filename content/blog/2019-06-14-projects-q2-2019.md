...
In the last two months I've migrated my blog & website from [Ghost](https://ghost.org/) to [Zola](https://www.getzola.org/). My experience so far has been good! Its worth enumerating the reasons why I migrated, ignoring morbid curiousity and the typical inability of a software engineer to not twiddle with perfectly good and functional systems.
...
The mechanics of this simuation were straightforward: 
...
- Trees that are on fire have a small chance of spreading fire to their neighbor trees.
