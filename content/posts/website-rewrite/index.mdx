...
Previously, I used [Zola](https://www.getzola.org/) to generate this site. There were a few reasons for a rewrite:
...
I make use of the [Typography plugin](https://github.com/tailwindlabs/tailwindcss-typography) to make the generated Markdown look pretty. I did however, have a few customizations for this plugin:
...
Quite early on, I settled on [mdx](https://mdxjs.com/) for authoring content. This allows you to augment Markdown with React components for custom elements. This brings a world of extensibility to this website.
