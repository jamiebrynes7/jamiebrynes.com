...
import uiElementImg from "./kudos-please-snippet.png";
import benchmarkFetch from "./kudos-please-benchmark.png";
import benchmarkIncrement from "./kudos-please-benchmark-increment.png";
...
A journey into this website's past when I had a fun little widget attached to each blog post!

<!--/excerpt-->

You may have noticed on each of my posts a small UI element like the following:

<Figure src={uiElementImg} caption="The curious UI element." />
...
<Lightbox
  src={benchmarkFetch}
  caption="A quick benchmark of fetching kudos on page load"
/>

<Lightbox
  src={benchmarkIncrement}
  caption="A quick benchmark of giving kudos."
/>
